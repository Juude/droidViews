package com.lewa.viewtest.debug;
...
import com.lewa.viewtest.mock.Mocker;
...
public class ViewDeugMocker extends Mocker{
    ...
    public void dump() {
        ...
        dumpViews.add(v);
        boolean skip = (MockUtils.getInt(mExtras, "skip", 1) == 1);
        boolean prop = (MockUtils.getInt(mExtras, "prop", 1) == 1);
