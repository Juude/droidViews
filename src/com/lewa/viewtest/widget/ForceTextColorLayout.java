...
public class ForceTextColorLayout extends LinearLayout{
    ...
    public ForceTextColorLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.lewa.viewtest.R.styleable.systemui,
                defStyle, 0);
        mColor = a.getColor(com.lewa.viewtest.R.styleable.systemui_forceTextColor, 0xFF000000);
        a.recycle();
