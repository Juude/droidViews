package net.juude.viewdemos.mock;
...
import net.juude.viewdemos.CommonActivity;
...
public class FragmentMocker extends Mocker {
    ...
    @Override
    public void dump() {
        startFragment(mContext, MockUtils.getString(mExtras, "fragment", "net.juude.viewdemos.CommonFragment"));
    }
}