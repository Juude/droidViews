package com.juude.viewdemos.mock;
...
import com.juude.viewdemos.CommonActivity;
...
public class FragmentMocker extends Mocker {
    ...
    @Override
    public void dump() {
        startFragment(mContext, MockUtils.getString(mExtras, "fragment", "com.juude.viewdemos.CommonFragment"));
    }
}