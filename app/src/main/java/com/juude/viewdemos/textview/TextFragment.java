...
package com.juude.viewdemos.textview;
...
import com.juude.viewdemos.Utils;
...
public class TextFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        com.juude.viewdemos.Utils.addButton(this, layout, "lined_text_fragment", "startLinkedFragment");
